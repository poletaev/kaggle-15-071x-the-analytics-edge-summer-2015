...
ebayTreeModel <- rpart(sold ~ biddable + startprice + condition +cellular +
...
write.table(format(test[, c("UniqueID", "Probability1")], digits=9),
            file="../submissions/cart-model-2.csv",
